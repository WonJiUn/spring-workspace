...
public class MailController {
	...
	public void sendMail(HttpServletResponse response) throws Exception {
		...
		sb.append("<img src=\"https://search.pstatic.net/sunny/?src=https%3A%2F%2Fimage.utoimage.com%2Fpreview%2Fcp952602%2F2021%2F05%2F202105018297_500.jpg&type=a340\">\r\n");
		sb.append("</a>");
		
		String msg = sb.toString();
		
		ms.sendMail("sallyjelly2@naver.com", "(제목)광고", msg);
		
		//ms.sendMail("sallyjelly2@naver.com", "(제목)테스트 메일", "(내용)안녕하세요");
